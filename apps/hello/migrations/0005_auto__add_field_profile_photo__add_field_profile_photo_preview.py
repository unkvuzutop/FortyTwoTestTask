...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.photo_preview'
        db.add_column(u'hello_profile', 'photo_preview',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profile.photo_preview'
        db.delete_column(u'hello_profile', 'photo_preview')
